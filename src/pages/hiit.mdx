...
<header class="mb-8">
    <nav class="breadcrumb">
        <a href="/">Home</a> / HIIT for Older Adults
    </nav>
    <h1 class="text-3xl font-bold">An Easy HIIT Home Workout for Older Adults</h1>
</header>
...
<img src="/images/moving_squat_with_arm_sweep.png" alt="Person demonstrating moving squat with arm sweep exercise" width="600" height="400" loading="lazy" />
...
<img src="/images/side_kick.png" alt="Person demonstrating side kick exercise" width="600" height="400" loading="lazy" />
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
    <img src="/images/plank_stand1.png" alt="Person demonstrating plank stand exercise - starting position" width="600" height="400" loading="lazy" />
    <img src="/images/plank_stand2.png" alt="Person demonstrating plank stand exercise - plank position" width="600" height="400" loading="lazy" />
</div>
